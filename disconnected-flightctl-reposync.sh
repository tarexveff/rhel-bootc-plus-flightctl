...
export SKOPEO=false
export CONNECTED_SYSTEM=true
export DISCONNECTED_SYSTEM=true
...
skopeo copy docker://quay.io/sclorg/postgresql-16-c9s:20250214 docker://$CONTAINER_REPO/quay.io/sclorg/postgresql-16-c9s:latest
...
for component in cli-artifacts api periodic ui worker
...
# Redis wouldn’t pull…needed to log into docker hub and download/upload it
...
for component in cli-artifacts api periodic ui worker keycloak origin-cli postgres redis-7.4.1
